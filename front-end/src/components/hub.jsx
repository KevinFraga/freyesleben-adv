...
class Hub extends Component {
  ...
  nextSlide = () =>
    this.state.slide === this.state.max
      ? this.setState({ slide: 1 })
      : this.setState({ slide: this.state.slide + 1 });

  prevSlide = () =>
    this.state.slide === 1
      ? this.setState({ slide: this.state.max })
      : this.setState({ slide: this.state.slide - 1 });
          ...
          <ul class="slides">
            ...
            <li className={slide === 3 ? 'selected' : 'not'}>
              ...
              <div className="text-container">
                <div className="slide-text">
                  <h2>
                    DIREITOS TRABALHISTAS. HOMOLOGAÇÃO. DIREITO DO CONSUMIDOR.
                    COMPLIANCE. RECURSOS ADMINISTRATIVOS.
                  </h2>
                  <span className="line" />
            ...
            <li className={slide === 4 ? 'selected' : 'not'}>
              ...
              <div className="text-container">
                <div className="slide-text">
                  <h2>
                    CONTRATO. INDENIZAÇÃO. DIREITO DO CONSUMIDOR.
                    RESPONSABILIDADE CIVIL. PROPRIEDADE. USUCAPIÃO.
                  </h2>
                  <span className="line" />
                  <h1>DIREITO CIVIL</h1>
                  <span className="line" />
            ...
            <li className={slide === 5 ? 'selected' : 'not'}>
              ...
              <div className="text-container">
                <div className="slide-text">
                  <h2>
                    DIVÓRCIO. PARTILHA DE BENS. PENSÃO ALIMENTÍCIA. VISITAÇÃO.
                    ACORDO PRÉ-NUPCIAL. JUDICIAL E EXTRAJUDICIAL.
                  </h2>
                  <span className="line" />
            ...
            <li className={slide === 6 ? 'selected' : 'not'}>
              ...
              <div className="text-container">
                <div className="slide-text">
                  <h2>
                    NÓS CUIDAMOS DO SEU INVENTÁRIO. TESTAMENTOS & HERANÇAS.
            ...
            <li className={slide === 8 ? 'selected' : 'not'}>
              ...
              <div className="text-container">
                <div className="slide-text">
                  <h2>
                    RECUPERAÇÃO JUDICIAL. FALÊNCIA. HABILITAÇÃO E
                    RECLASSIFICAÇÃO DE CRÉDITO. ADMINISTRADOR JUDICIAL.
                  </h2>
                  <span className="line" />
            ...
            <li className={slide === 11 ? 'selected' : 'not'}>
              ...
              <div className="text-container">
                <div className="slide-text">
                  <h2>
                    INVENTÁRIO E EMPRÉSTIMOS. ACORDOS JUDICIAL E EXTRAJUDICIAL.
                  </h2>
                  <span className="line" />
                  <h1>AERUS</h1>
                  <span className="line" />
            ...
            <li className={slide === 13 ? 'selected' : 'not'}>
              ...
              <div className="text-container">
                <div className="slide-text">
                  <h2>
                    LEI DE INCENTIVO À CULTURA E AO ESPORTE. LEI ROAUNET.
                    FUTEBOL S.A.
                  </h2>
                  <span className="line" />
            ...
            <li className={slide === 15 ? 'selected' : 'not'}>
              <div class="slide-image">
                <img src="/slide15.jpeg" alt="slide" />
              </div>
              <div className="text-container">
                <div className="slide-text">
                  <h2>
                    REVISÃO VIDA TODA, APOSENTADORIA, APOSENTADORIA ESPECIAL.
                  </h2>
                  <span className="line" />
                  <h1>DIREITO PREVIDÊNCIÁRIO</h1>
                  <span className="line" />
                </div>
              </div>
              {this.carouselControls()}
            </li>
            <li className={slide === 16 ? 'selected' : 'not'}>
              <div class="slide-image">
                <img src="/slide16.jpeg" alt="slide" />
              </div>
              <div className="text-container">
                <div className="slide-text">
