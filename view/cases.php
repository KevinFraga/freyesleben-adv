...
<main class="page-container">
  <div>
    <div class="title-display">
      <p class="title" id="fgts">Ação Revisional do FGTS</p>
    </div>
  ...
  <div>
    <div class="title-display">
      <p class="title" id="emprestimos_AERUS">Ação Monitória Empréstimos AERUS</p>
    </div>
  ...
  <div>
    <div class="title-display">
      <p class="title" id="inventario_AERUS">Ação Inventário incluindo o bem: benefício AERUS</p>
    </div>
  ...
  <div>
    <div class="title-display">
      <p class="title" id="rateio">Recebimento de Verbas Trabalhistas (Rateios) da Massa Falida</p>
    </div>
